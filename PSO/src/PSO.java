...
//	public static int firstIterationData;
	...
	public static void main(String[] args) {
		...
		try {
			...
			boolean gnuplotScriptsByGainsNeeded = false;
			...
			boolean doFNN_VonNEUMANN = false;
...
//			double[] gainsList = { 0.0001, 0.01, 0.14, 0.16, 0.20, 0.21, 0.23 }; 
			...
			boolean doSpontActLevel1 = false;   
			...
			// PROBABILITY
			//Probability 
			double[] probabilityList = {0.8, 0.9};
			
			int currentNumParticles = 50;
			int numParticlesIndex = 0;
			...
			for (int topoIndex = 0 ; topoIndex < topologiesList.length ; ++topoIndex) {
				...
				//			System.out.println("currentTopology = " + topoIndex);
...
//										continue;
								for (int probabilityIndex = 0; probabilityIndex < probabilityList.length; probabilityIndex ++) {
									double probability = probabilityList[probabilityIndex];
									int currentLatticeSideSize = (int) Math.sqrt( currentNumParticles / probability ) + 1;
									System.out.println("probability " + probability);
									//								System.out.println("                     latticeSize = " + currentLatticeSideSize);
									int latticeIndex = 0 ;


//									// GAIN
//									// ========
									double currentGain = gainsList[0];
									double currentSpontActLevel = spontActLevelsList[0];
									double currentSpontActProb = spontActProbsList[0];
													...
													for (int numDimensionsIndex = 0 ; numDimensionsIndex < doNumDims.length ; ++numDimensionsIndex ) {
														...
														if (finalFuncValsByNumParticlesDataFileNeeded) {
															...
															outputTestParameters(finalFuncValByNumParticlesDataFile, currentPSOTopology, currentPSOSelfModel, currentPSOInfluenceModel, 
																	...
																	currentSpontActLevel, currentSpontActProb, probability);		
															                                            ...
															                                            [selfIndex]
															                                             [influenceIndex]
															                                              [latticeIndex]
															                                               [0]
															                                                [0]
															                                                 [0] = "final-func-val-data-" + fileName;
														}
															...
															for (numIterationsIndex = 0, numFEsIndex = 0 ; numIterationsIndex < doNumIterations.length && numFEsIndex < doNumFEs.length ; ++numIterationsIndex, ++numFEsIndex ) {
																...
																for (currentRunNum = 0 ; currentRunNum < totalNumRuns ; ++currentRunNum) {
																	...
																	Swarm swarm = new Swarm (currentNumParticles, numParticlesIndex, currentFunctionNum, currentNumDimensions, 
																			...
																			currentLatticeSideSize, currentGain, sumNeighborActivationsThreshold, activationThreshold, 
																			currentSpontActLevel, currentSpontActProb, intervalData, probability);
...
//									}  // END GAIN FOR-LOOP  
								...
								} // END LATTICE SIZE FOR-LOOP (PROBABILITY FOR-LOOP)    
...
//				}
	...
	public static void outputTestParameters(PrintWriter resultsOutputFile, Topology currentPSOTopology, SelfModel currentPSOSelfModel, InfluenceModel currentPSOInfluenceModel, 
			...
			double spontaneousActivationLevel, double spontaneousActivationProbability, double probability) {


		resultsOutputFile.println("# probability = " + probability);
